...
component MAC_TOP port (
	...
	-- Port 4
	port4_EN      : in  std_logic;
	port4_dstMac  : in  std_logic_vector(47 downto 0);
	port4_srcMac  : in  std_logic_vector(47 downto 0);
	port4_dstPort : out std_logic_vector(2 downto 0);
	port4_done    : out std_logic;
...
Mac_Top1: MAC_TOP port map(
	...
	port1_EN => En_Mac_1,
	port1_dstMac => Dst_Mac_1,
	port1_srcMac => Src_Mac_1,
	port1_dstPort => Dst_Port_in_1,
	port1_done => En_Port_in_1,

	port2_EN => En_Mac_2,
	port2_dstMac => Dst_Mac_2,
	port2_srcMac => Src_Mac_2,
	port2_dstPort => Dst_Port_in_2,
	port2_done => En_Port_in_2,

	port3_EN => En_Mac_3,
	port3_dstMac => Dst_Mac_3,
	port3_srcMac => Src_Mac_3,
	port3_dstPort => Dst_Port_in_3,
	port3_done => En_Port_in_3,

	port4_EN => En_Mac_4,
	port4_dstMac => Dst_Mac_4,
	port4_srcMac => Src_Mac_4,
	port4_dstPort => Dst_Port_in_4,
	port4_done => En_Port_in_4
);
